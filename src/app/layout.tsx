...
export const metadata: Metadata = {
  ...
  robots: {
   ...
   openGraph: {
     ...
     images: [
       {
         url: "https://asamiheaven.vercel.app/icon.png",
         secureUrl: "https://asamiheaven.vercel.app/icon.png",
         width: 32,
         height: 32,
         alt: "Asami Heaven Logo",
         type: "image/png",
       },
     ],
   },
   twitter: {
     ...
     images: ["https://asamiheaven.vercel.app/icon.png"],
     creator: "@asamiheaven",
   },
  alternates: {
